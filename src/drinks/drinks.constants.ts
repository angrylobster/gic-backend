type TBeer = 'Ale' | 'Porter' | 'Stout' | 'Brown Ale' | 'Pale Ale' | 'IPA';

export const BEER_DESCRIPTION_MAP: Record<TBeer, string> = {
...
export const BEER_SUBSTRING_MAP: Record<string, TBeer> = {
  India: 'IPA',
  IPA: 'IPA',
  Brown: 'Brown Ale',
  'Brown Ale': 'Brown Ale',
...
export const BEER_NAME_TYPE_MAP: Record<string, TBeer> = {
  'Guinness Draught': 'Stout',
};

export const DRINK_RATING_MAXIMUM = 5;
export const DRINK_RATING_DECIMAL_PLACES = 3;
export const COFFEE_PRICE_MINIMUM = 8;
export const COFFEE_PRICE_MAXIMUM = 20;
